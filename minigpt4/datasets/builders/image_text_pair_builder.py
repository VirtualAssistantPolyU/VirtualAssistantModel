...
from minigpt4.datasets.datasets.polyu_dataset import PolyuDataset
...
@registry.register_builder("polyu_dataset")
class PolyUBuilder(BaseDatasetBuilder):
    train_dataset_cls = PolyuDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/polyu/default.yaml"}
